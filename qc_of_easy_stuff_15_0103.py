...
def get_fields():
    ...
    with open('Master_Header_File_15_0103.xlsx', 'rb') as master_header_file:
...
def eligibility_check():
    with open('15_0103_Eligibility.xlsx', 'rb') as eligibility_file:
        ...
        eligibility_workbook.save('15_0103_Eligibility_w_highlighted_erroros.xlsx')

def demographic_check():
    with open('15_0103_Demographic.xlsx', 'rb') as demographic_file:
        ...
        demographic_workbook.save('15_0103_demographic_w_highlighted_erroros.xlsx')
        
def symptoms_check():
    with open('15_0103_Symptoms.xlsx', 'rb') as symptoms_file:
        ...
        symptoms_workbook.save('15_0103_symptoms_w_highlighted_erroros.xlsx')

def medical_check():
    with open('15_0103_medical.xlsx', 'rb') as medical_file:
        ...
        medical_workbook.save('15_0103_medical_w_highlighted_erroros.xlsx')

def enrollment_specimen_check():
    with open('15_0103_Enrollment_Specimen.xlsx', 'rb') as enrollment_specimen_file:
        ...
        enrollment_specimen_workbook.save('15_0103_enrollment_specimen_w_highlighted_erroros.xlsx')
def main():
    eligibility_check()
    demographic_check()
    symptoms_check()
